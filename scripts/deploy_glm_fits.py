...
def get_unit_count(ecephys_session_id):
    ...
    return len(unit_table.query('ecephys_session_id == @ecephys_session_id',engine='python'))
...
if __name__ == "__main__":
    ...
    experiments_table = glm_params.get_experiment_table().reset_index()
    ...
    for experiment_id in experiment_ids[int(n_experiment_ids * args.job_start_fraction): int(n_experiment_ids * args.job_end_fraction)]:
        ...
        unit_count = get_unit_count(experiment_id)
